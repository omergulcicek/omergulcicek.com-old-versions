...
import { AboutTurkuaz, AboutTurkceDokuman, AboutMail, AboutCompany, AboutFigure, Svg, Hr, H2Title, GetInTouch, Button } from "../components/Styled"
...
const About = () => (
  <Layout>
    ...
    <section className="about">
      ...
      <p>
        Yazılım mühendisliği alanında lisans derecem var. Frontend Developer'ım; <AboutCompany href="https://www.gordionteknoloji.com" target="_blank" rel="noopener noreferrer">Gordion Teknoloji</AboutCompany>'de çalışıyorum. UI/UX alanında uzmanlaşmayı hedefliyorum. Kod benim için bir tutku.
      </p>
      ...
      <ul>
        ...
        <li>Haftasonumu İstanbul'a ayrıyorum, sürekli farklı yerleri geziyorum.</li>
        <li>Sıkı bir satranç oyuncusuyum. Yıllardır günlük 5 maç ortalamasıyla oynuyorum, turnuvalara katılıyorum.</li>
        <li>Rubik küp çözebiliyorum, rekorum 57 sn.</li>
